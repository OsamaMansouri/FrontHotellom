...
const RoomsAdd = () => {
   ...
   const ToastContent = ({ room }) => (
    <>
        ...
        <div className='toastify-body'>
            <span>Room {room} has been successfully added !</span>
        </div>
    </>
)
   ...
   const handleFormSubmit = () => {
       ...
       axiosInstance.post('/add_room', formData, config).then(res => {
        toast.success(
                       ...
                       <Col sm="12">
                           ...
                           <Row>
                               <Col sm='12' className='d-flex align-items-end'>
                                   <Button color='primary' onClick={handleFormSubmit}>Create Room</Button>
                               </Col>
                           </Row>
                       </Col>
                   </Row>

        ...
        children: [
          {
            ...
            title: 'Welcome',
            permissions: ['admin', 'editor'],
            navLink: 'https://pixinvent.com/demo/Hotellom-mail-template/mail-welcome.html',
            externalLink: true
          },
          {
            id: 'resetPassTemp',
            ...
            permissions: ['admin', 'editor'],
            navLink: 'https://pixinvent.com/demo/Hotellom-mail-template/mail-reset-password.html',
            externalLink: true
          },
          {
            id: 'verifyEmailTemp',
            title: 'Verify Email',
            permissions: ['admin', 'editor'],
            navLink: 'https://pixinvent.com/demo/Hotellom-mail-template/mail-verify-email.html',
            externalLink: true
          },
          {
            ...
            permissions: ['admin', 'editor'],
            navLink: 'https://pixinvent.com/demo/Hotellom-mail-template/mail-deactivate-account.html',
            externalLink: true
          },
          {
            id: 'invoiceMailTemp',
            title: 'Invoice',
            permissions: ['admin', 'editor'],
            navLink: 'https://pixinvent.com/demo/Hotellom-mail-template/mail-invoice.html',
            externalLink: true
          },
          {
            ...
            title: 'Promotional',
            permissions: ['admin', 'editor'],
            navLink: 'https://pixinvent.com/demo/Hotellom-mail-template/mail-promotional.html',
            externalLink: true
          }
        ]
      },

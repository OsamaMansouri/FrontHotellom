    ...
    <Row>
      <Col md='6' sm='12'>
        <div className='p-3 bg-primary my-2 rounded'>
          <Toast>
            <ToastHeader close={close}>Hotellom</ToastHeader>
            <ToastBody>
...
const ToastHeaderIcons = () => {
  return (
    <Row>
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='primary'>Hotellom</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='success'>Hotellom</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='info'>Hotellom</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='danger'>Hotellom</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='warning'>Hotellom</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='dark'>Hotellom</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
        <ToastHeader close={close} icon={logo}>Hotellom</ToastHeader>
